     ...
     Sheet s1=    w1.getSheet("logindetails");
       Row r1=      s1.getRow(1);
         ...
         // String s2= c1.getStringCellValue();
          ...
          String usrname=NumberToTextConverter.toText(w1.getSheet("logindetails").getRow(2).getCell(0).getNumericCellValue());
          String pwd=w1.getSheet("logindetails").getRow(2).getCell(1).getStringCellValue();
